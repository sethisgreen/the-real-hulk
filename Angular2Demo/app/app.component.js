System.register(['@angular/core', '@angular/http', 'rxjs/Rx', '@angular/router', './products/product-list.component', './products/product.service', './home/welcome.component', './products/product-detail.component', './books/book-list.component', './books/book-detail.component', './books/book.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, router_1, product_list_component_1, product_service_1, welcome_component_1, product_detail_component_1, book_list_component_1, book_detail_component_1, book_service_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
